...
║  STACK   ›  React / Node / Django / PostgreSQL / AWS                        ║
║  STUDY   ›  B.Tech CSE  —  ITER, SOA University, Bhubaneswar               ║
║  STATUS  ›  Building  •  Sharpening DSA  •  Exploring AI Engineering        ║
╚══════════════════════════════════════════════════════════════════════════════╝
```
...
A production-grade movie booking platform — not a clone, a real product. 10-min temporary seat holds, coupon engine, JWT auth, QR digital tickets, admin analytics.
...
Coding contest platform with AI-powered hints, remote code execution, real-time camera proctoring and premium subscriptions.

```yaml
Backend:  Django · PostgreSQL
AI:       Gemini API
Proctor:  OpenCV · MediaPipe
Executor: HackerEarth API
...
<img src="https://skillicons.dev/icons?i=java,python,typescript,javascript,cpp,c,html,css&theme=dark&perline=8"/>

<br/><br/>

**— Frontend —**

<img src="https://skillicons.dev/icons?i=react,nextjs,vite,tailwind&theme=dark&perline=8"/>

<br/><br/>

**— Backend —**

<img src="https://skillicons.dev/icons?i=nodejs,express,django&theme=dark&perline=8"/>

<br/><br/>

**— Data —**

<img src="https://skillicons.dev/icons?i=postgres,mongodb,mysql,prisma,supabase&theme=dark&perline=8"/>

<br/><br/>

**— Cloud · DevOps · AI —**

<img src="https://skillicons.dev/icons?i=aws,docker,githubactions,linux,git,opencv&theme=dark&perline=8"/>
...
<img src="https://github-profile-trophy.vercel.app/?username=Prasenjit-Sahoo18&theme=algolia&no-frame=true&no-bg=false&margin-w=6&row=1&column=7" width="98%"/>
...
┌─────────────────────────────────────────────────────────────────────────┐
│                                                                         │
│   IDEA  ──►  ARCHITECTURE  ──►  BUILD  ──►  VALIDATE  ──►  SHIP        │
│                 │                 │                         │           │
│               Frontend          API                      iterate ↺     │
│               Backend         Database                                  │
│                 └───────────────┘                                       │
│                                                                         │
│   Product > Prototype   ·   Security by default   ·   Ship & iterate   │
│                                                                         │
└─────────────────────────────────────────────────────────────────────────┘
```
...
|:---:|:---|
| 🎯 **Product First** | Every project solves a real use case |
| 🔐 **Secure by Default** | Auth, validation and access control from day one |
| ⚡ **Performance** | Efficient queries, optimised APIs, responsive UI |
| 🧪 **Testability** | Validate before calling anything finished |
| 🚀 **Ship** | A deployed product beats a perfect localhost |
...
### ◈ &nbsp; L E A R N I N G &nbsp; T R A J E C T O R Y &nbsp; ◈
...
```
  NOW                                   NEXT
  ───────────────────────────────────────────────────────────────
  Full-Stack Development        ──────►  System Design (HLD/LLD)
  AI Product Integration        ──────►  AI Engineering & MLOps
  Cloud Basics (Render/Heroku)  ──────►  AWS + Docker + CI/CD
  REST APIs                     ──────►  gRPC · WebSockets · Kafka
  ───────────────────────────────────────────────────────────────
  Currently practising: DSA (LeetCode) · Competitive Programming
```
